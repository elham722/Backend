...
namespace Client.MVC.Services.Infrastructure
{
    /// <summary>
    ...
    public class ResiliencePolicyService
    {
        ...
        private ResiliencePolicyConfig LoadPolicyConfig(IConfiguration configuration, string sectionName)
        {
            ...
            return new ResiliencePolicyConfig
            {
                ...
                RetryDelaySeconds = section.GetValue("RetryDelaySeconds", 2),
                CircuitBreakerThreshold = section.GetValue("CircuitBreakerThreshold", 3),
